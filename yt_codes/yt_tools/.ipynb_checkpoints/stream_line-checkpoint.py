...
class Spherical_magline():
    ...
    **kwargs : dict
    ...
    def __init__(self, Brtp, rtp, **kwargs):
        ...
        self.dl   = kwargs.get('step_length', rtp[1,0,0,0]-rtp[0,0,0,0])
    ...
    def magline_solver(self, rtps, **kwargs):
        ...
        if parallel:
            ...
            n_chunks = n_tasks//Nc
            res      = n_tasks % Nc
            chunks   = [n_chunks+1]*res+[n_chunks]*(Nc-res)
            idx_i    = 0
            idx_f    = 0
